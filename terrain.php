...
<div id="map" ></div>
<div id="zcon" style="position:absolute; left :50px;top: 4px; background-color:rgba(255,255,255,0.3);padding:2px;">
   <div id="help"  style="margin:3px;"> <button onclick="moveLocation()">center</button><button onclick="clearmap()">clear</button>
<textarea placeholder="Add location tags here..." id="tinfo" style="width:160px; height:16px;"><?php echo $info;?></textarea>
</div>
   <span id="goog"  style="padding:3px;"> <a href="https://www.google.com/maps/dir/Current+Location/<?php echo $lat.','. $lon;?>" target="_blank"><img src="gmap.png" height=40 /></a><a href="http://waze.to/?ll=<?php echo $lat.','. $lon;?>&navigate=yes"><img src="waze.png" height=40px /></a></span>
<span id="atlas"  style="padding:3px;">
  <a href="<?php echo $actual_link?>">
  <img src="ai.png" height=40 /></a></span>

<div id="textar2" style="padding:2px;"> </div>
<div id="lonlat" style="padding:2px;" ><?php echo round($lon,6).', '.round($lat,6).' '.$zz.'';?></div>
...
function getcsv(fns,style,width)
{
 ...
 var BingLayer = L.TileLayer.extend({
  ...
  var terrain = L.tileLayer('https://a.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
    maxZoom: 18,
...
var linkText = ' <a href="terrain.php?lon='+lon+'&lat='+lat+'&zoom='+zoom+'&info='+ inf + '&jsi='+ jsi +'" target="_blank"><img src="ai.png" height=50px /></a>';
