...
var linkText = ' <a href="index.php?lon='+lon+'&lat='+lat+'&zoom='+zoom+'&info='+ inf + '&jsi='+ jsi +'" target="_blank"><img src="ai.png" height=50px /></a>';
 
    $('#atlas').html(linkText);
$('#lonlat').html(""+lat.toFixed(6)+","+lon.toFixed(6)+ ","+zoom);
